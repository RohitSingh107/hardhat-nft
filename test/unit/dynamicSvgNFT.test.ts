...
!developmentChains.includes(network.name)
  ...
  : describe("Dynamic Svg NFT tests", () => {
      ...
      describe("constructor", () => {
        it("Sets the aggregator address and svg correctly", async () => {
          const response = await dynamicSvgNft.getPriceFeed()
      ...
      describe("Mint NFT", () => {
        it("Emits the CreatedNFT event and sets update state", async () => {
        ...
        it("shifts the token uri to lower when the price doesnot surpass the highValue", async () => {
